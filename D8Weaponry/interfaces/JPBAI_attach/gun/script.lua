require("/D8Weaponry/interfaces/JPBAI_attach/main.lua")
...
function buildAttachList()
    ...
    attachCfg.munition = {
        ...
        func = "munition",
        icon = "/D8Weaponry/interfaces/JPBAI_attach/gun/icon/munition.png"
    }
    local list = "attachKind.list"
    ...
    if #curMag == 0 then
        ...
        local item = {
            ...
            parameters = {
                ...
                inventoryIcon = "/D8Weaponry/interfaces/JPBAI_attach/gun/icon/munition.png",
                placementImage = "/D8Weaponry/interfaces/JPBAI_attach/gun/icon/munition.png"
            },
            count = 0
        }
        widget.setItemSlotItem(path .. ".itemIcon", item)
