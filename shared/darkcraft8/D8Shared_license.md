...
## You may put those shared file in your mod if you follow the following
 ...
 - Do not modifie contained files or their path
  ...
  a few file are exempt from the path rules due to the way the game is programmed.
  
 - Do not copy raw line of codes of the contained files
 
 - Do not remove/move this license
